...
<div class="col-md-6 label-col form-group">
    ...
    <div class="col-md-10">
        ...
        <div id="div_tra_{{$t->id}}" class="controls" style="display: none;">
            ...
            <textarea id="des_tra_{{$t->id}}" class="textarea form-control" cols="30" id="id_ad-other_info" name="terminos" rows="10" placeholder="Escriba la descripción del anuncio aquí" ></textarea>
        </div>
    </div>
